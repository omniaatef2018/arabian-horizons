...
<div class="test-page">
    <div class="cookie">
        <div class="container">
            <h1><b>Cookie Policy for www.arabiahorizons.com</b></h1>
            <p>This is the cookie policy for www.arabiahorizons.com, accessible from www.arabiahorizons.com/cookie</p>
            ...
            <p>We use cookies for a variety of reasons detailed below. Unfortunately in most cases there are no industry
                ...
                add
                to this site. It is recommended that you leave on all cookies if you are not sure whether you need them
                or
            ...
            <ul>
                ...
                <li>
                    <b>Orders processing related cookies</b>
                    <p>This site offers e-commerce or payment facilities and some cookies are essential to ensure that
                        your
                ...
                <li>
                    ...
                    <p>In order to provide you with a great experience on this site we provide the functionality to set
                        ...
                        need to
                        set cookies so that this information can be called whenever you interact with a page is affected
                        by
                        your preferences.</p>
                </li>
            </ul>
            ...
            <ul>
                ...
                <li>
                    <p>From time to time we test new features and make subtle changes to the way that the site is
                        ...
                        consistent experience whilst on the site whilst ensuring we understand which optimisations our
                        users
                        appreciate the most.</p>
                </li>
                <li>
                    <p>As we sell products it's important for us to understand statistics about how many of the visitors
                        to
                        our site actually make a purchase and as such this is the kind of data that these cookies will
                        track. This is important to you as it means that we can accurately make business predictions
                        that
                        allow us to monitor our advertising and product costs to ensure the best possible price.</p>
                </li>
                <li>
                ...
                <li>
                    <p>Several partners advertise on our behalf and affiliate tracking cookies simply allow us to see if
                        our
                        customers have come to the site through one of our partner sites so that we can credit them
                        appropriately and where applicable allow our affiliate partners to provide any bonus that they
                        may
                        provide you for making a purchase.</p>
                </li>
                <li>
                    <p>We also use social media buttons and/or plugins on this site that allow you to connect with your
                        ...
                        {List
                        the social networks whose features you have integrated with your site?:12}, will set cookies
                        through
            ...
            <p>However if you are still looking for more information then you can contact us through one of our
                preferred
                contact methods in <a href="/contact" target="_blank">contact form</a></p>
        </div>
    </div>
</div>
